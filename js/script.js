...
function Page() {
    ...
    this.refreshHistoric = function (info, n) {
        ...
        const ZENICA BLUES  = 'img/izveduvaci/856.jpg';
        const DODIRNI MI KOLENA = 'img/izveduvaci/857.jpg';
        const JABUKE I VINO = 'img/izveduvaci/858.jpg';
        const MAJSTOR ZA POLJUPCE = 'img/izveduvaci/859.jpg';
        const MLADICU MOJ = 'img/izveduvaci/860.jpg';
        const HAJDE DA LUDUJEMO = 'img/izveduvaci/861.jpg';
        const TI NEMAS PRAVA NA MENE = 'img/izveduvaci/862.jpg';
        const NE BOJIM SE DRUGOVA TVOGA FRAJERA = 'img/izveduvaci/863.jpg';
        const STVARI LAGANE = 'img/izveduvaci/864.jpg';
        const TI ME IZLUDUJES = 'img/izveduvaci/865.jpg';
        const A TI SI MANGUP = 'img/izveduvaci/866.jpg';
        const IMA JEDAN SVIJET = 'img/izveduvaci/867.jpg';
        const SVE JE NEOBICNO AKO TE VOLIM = 'img/izveduvaci/868.jpg';
        const STIPU GATIBO = 'img/izveduvaci/869.jpg';
        const STO NE ZNAM GDE SI SAD = 'img/izveduvaci/870.jpg';
        const VOJAN POSTA = 'img/izveduvaci/871.jpg';
        const ZNAM I OSECAM = 'img/izveduvaci/872.jpg';
        const OZENICES SE TI = 'img/izveduvaci/873.jpg';
        const RUKUJU SE RUKUJU = 'img/izveduvaci/874.jpg';
        const ZANA VEJTE SNEGOVI = 'img/izveduvaci/875.jpg';
        const RAT I MIR = 'img/izveduvaci/876.jpg';
